...
@Component({
  selector: 'app-workshop-service',
  templateUrl: './workshop-service.page.html',
  styleUrls: ['./workshop-service.page.scss'],
})

export class WorkshopServicePage implements OnInit {
